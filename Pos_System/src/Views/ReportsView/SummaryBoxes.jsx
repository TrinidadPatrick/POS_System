...
const SummaryBoxes = () => {
  ...
  return (
    <div className='h-full w-full grid grid-cols-2 sm:grid-cols-4 md:grid-cols-2 gap-2'>
        <div className='bg-white shadow-sm rounded flex'>
          <div className='h-full flex flex-col justify-center  ps-5 pe-3'>
            <MdOutlineShoppingCart size={width <= 767 ? 30 : 35} />
          </div>
          <div className='flex-1 flex flex-col justify-center items-start'>
            <h6 className="text-sm md:text-base font-medium text-gray-800">Net Sales</h6>
            <p className='text-sm md:text-lg font-extrabold'>{report.net_sales}</p>
          </div>
        </div>
        <div className='bg-white shadow-sm rounded flex'>
          <div className='h-full flex flex-col justify-center ps-5 pe-3'>
          <CiReceipt size={width <= 767 ? 30 : 35} />
          </div>
          <div className='flex-1 flex flex-col justify-center items-start'>
            <h6 className="text-sm md:text-base font-medium text-gray-800">Expense</h6>
            <p className='text-sm md:text-lg font-extrabold'>{Number(report.expense)}</p>
          </div>
        </div>
        <div className='bg-white  shadow-sm rounded flex'>
          <div className='h-full flex flex-col justify-center ps-5 pe-3'>
          ...
          <div className='flex-1 flex flex-col justify-center items-start'>
            <h6 className="text-sm md:text-base font-medium text-gray-800">Product Sold</h6>
            <p className='text-sm md:text-lg font-extrabold'>{report.product_sold}</p>
          </div>
        </div>
        <div className='bg-white shadow-sm rounded flex'>
          <div className='h-full flex flex-col justify-center ps-5 pe-3'>
          ...
          <div className='flex-1 flex flex-col justify-center items-start'>
            <h6 className="text-sm md:text-base font-medium text-gray-800">Profit</h6>
            <p className='text-sm md:text-lg font-extrabold'>{report.profit}</p>
          </div>
        </div>
    </div>
  )
