...
const AddProductModal = ({setIsProductModalOpen}) => {
  ...
  return (
    ...
    <h2 className="text-lg text-gray-700 font-semibold mb-4">Add Product</h2>
    <form onSubmit={(e)=>submitProduct(e)} >
      ...
      <div className={`w-full ${variants.length === 0 ? 'hidden' : 'flex'} mt-2 `}>
      ...
      <div className="flex items-center justify-end gap-2 mt-3">
        ...
        <button type="submit" className=" bg-theme-dark text-white font-medium text-sm w-24 h-9 flex justify-center items-center rounded focus:outline-none focus:shadow-outline">
          {
            loading ?  <LoadingProcess /> : 'Add Product'
          }
        </button>
      </div>
    </form>
